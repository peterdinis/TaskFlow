...
const getSubTodosByParentSchema = z.object({
  userId: z.string(),
  parentId: z.string(),
})

const getSubTodosByProjectSchema = z.object({
  userId: z.string(),
  projectId: z.string(),
})

const getSubTodosByLabelSchema = z.object({
  userId: z.string(),
  labelId: z.string(),
})

const getSubTodosDueBeforeSchema = z.object({
  userId: z.string(),
  dueDate: z.number().positive(),
})

const searchSubTodosSchema = z.object({
  userId: z.string(),
  embedding: z.array(z.number()).length(1536),
  limit: z.number().min(1).max(100).optional(),
})

// CREATE - Add a new subTodo
