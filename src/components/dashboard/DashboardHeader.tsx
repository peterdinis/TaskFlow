...
import { Menu, Search, Bell, Plus, FolderPlus, Palette, Hash, Calendar, Book, Target, Star, Briefcase } from 'lucide-react';
...
interface DashboardHeaderProps {
  ...
  onCreateProject?: (projectData: { name: string; color: string; icon: string }) => void;
}
            ...
            <div className="space-y-6 py-4">
                    ...
                    {projectIcons.map((icon) => {
                      ...
                      return (
                        <motion.button
                          ...
                          whileTap={{ scale: 0.95 }}
                          onClick={() => setProjectData({ ...projectData, icon: icon.icon })}
                          className={`
              ...
              <div className="rounded-lg bg-muted/50 p-4 border border-border">
                <div className="flex items-center gap-3">
                  ...
                  >
                    {(() => {
                      const IconComponent = projectIcons.find(i => i.icon === projectData.icon)?.component || Briefcase;
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <Badge variant="outline" className="text-xs">
                        {projectIcons.find(i => i.icon === projectData.icon)?.name || 'Briefcase'}
                      </Badge>
                    </div>
                    <p className="text-xs text-muted-foreground">
